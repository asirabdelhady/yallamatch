...
const content = {
    ar: {
        ...
        weGot: "ماتشك عندنا .. ناقصنا انت ",
        registerNow: "سجل دلوقتي",
        whoAreWe: "احنا مين ؟",
        whoList: [
            "احنا كومينتي بيسهل عليك لعب اي ماتش",
            "سواء تعرف ناس او متعرفش",
            "سواء عندك فرقة او معندكش",
            "دايما هتلاقي ماتشات",
            "اختار اللي يناسبك و تعالا ",
        ],
        whyUs: "ليه احنا ؟",
        whyText: "عندنا فريق كامل بيسهل عليك طريقة الحجز في اي ماتش من غير ما تتعب نفسك و تنزل تدور وهيوصلك تاكيد بالماتش اللي هتختاره ، غير انك دايما هتلاقي ماتش يناسبك و اننا دايما موجودين حواليك",
        howToRegister: "أسجل ازاي ؟",
        registerStep: "اختار  الماتش اللي يناسبك",
        followInstagram: "تابعنا على انستجرام",
        joinTelegram: "ادخل جروب التليجرام",
        contactUs: "اتواصل معانا",
        contactText: "ادخل جروب التليجرام عشان يوصلك الاشعارات و تابعنا على الانستجرام عشان يوصلك اجدد الاخبار",
        navWho: "احنا مين ؟",
        navWhy: "ليه احنا ؟",
        navHow: "التسجيل",
        navContact: "التواصل",
